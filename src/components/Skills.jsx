...
const Skills = () => {
    ...
    <div className='p-4 w-full'>
        <h1 className='mt-12 text-white text-4xl mb-10'>My Tech Stack</h1>
        <div className= 'grid grid-cols-3 md:grid-cols-6 w-full gap-y-10'>
        ...
        <p className='text-gray-100 uppercase'>Css3 [BEM]</p>
        </div>
